<template>
  <div>
    <h2 id="page-heading" data-cy="ExperienceHeading">
      <span v-text="$t('demoJhVue973App.experience.home.title')" id="experience-heading">Experiences</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('demoJhVue973App.experience.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'ExperienceCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('demoJhVue973App.experience.home.createLabel')"> Create a new Experience </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && experiences && experiences.length === 0">
      <span v-text="$t('demoJhVue973App.experience.home.notFound')">No experiences found</span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="experiences">
        ...
        <tbody>
          <tr v-for="experience in experiences" :key="experience.id" data-cy="entityTable">
            ...
            <td v-text="$t('demoJhVue973App.Contract.' + experience.contract)">{{ experience.contract }}</td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="demoJhVue973App.experience.delete.question" data-cy="experienceDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-experience-heading" v-text="$t('demoJhVue973App.experience.delete.question', { id: removeId })">
