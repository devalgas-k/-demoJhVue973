  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="demoJhVue973App.experience.home.createOrEditLabel"
          data-cy="ExperienceCreateUpdateHeading"
          v-text="$t('demoJhVue973App.experience.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.experience.title')" for="experience-title">Title</label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.experience.company')" for="experience-company">Company</label>
            <input
              type="text"
              class="form-control"
              name="company"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.experience.description')" for="experience-description"
              >Description</label
            >
            <textarea
              class="form-control"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.experience.logoCompany')" for="experience-logoCompany"
              >Logo Company</label
            >
            <div>
              <img
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.experience.inProgress')" for="experience-inProgress"
              >In Progress</label
            >
            <input
              type="checkbox"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.experience.contract')" for="experience-contract">Contract</label>
            <select
              class="form-control"
              name="contract"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.experience.startDate')" for="experience-startDate"
              >Start Date</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.experience.endDate')" for="experience-endDate">End Date</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
          ...
          <div class="form-group">
            <label v-text="$t('demoJhVue973App.experience.expertise')" for="experience-expertise">Expertise</label>
            <select
              class="form-control"
