<template>
  <div>
    <h2 id="page-heading" data-cy="EmployeeHeading">
      <span v-text="$t('demoJhVue973App.employee.home.title')" id="employee-heading">Employees</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('demoJhVue973App.employee.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'EmployeeCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('demoJhVue973App.employee.home.createLabel')"> Create a new Employee </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && employees && employees.length === 0">
      <span v-text="$t('demoJhVue973App.employee.home.notFound')">No employees found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('firstName')">
              <span v-text="$t('demoJhVue973App.employee.firstName')">First Name</span>
            ...
            <th scope="row" v-on:click="changeOrder('lastName')">
              <span v-text="$t('demoJhVue973App.employee.lastName')">Last Name</span>
            ...
            <th scope="row" v-on:click="changeOrder('email')">
              <span v-text="$t('demoJhVue973App.employee.email')">Email</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'email'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('phoneNumber')">
              <span v-text="$t('demoJhVue973App.employee.phoneNumber')">Phone Number</span>
            ...
            <th scope="row" v-on:click="changeOrder('hireDate')">
              <span v-text="$t('demoJhVue973App.employee.hireDate')">Hire Date</span>
            ...
            <th scope="row" v-on:click="changeOrder('salary')">
              <span v-text="$t('demoJhVue973App.employee.salary')">Salary</span>
            ...
            <th scope="row" v-on:click="changeOrder('department.id')">
              <span v-text="$t('demoJhVue973App.employee.department')">Department</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="demoJhVue973App.employee.delete.question" data-cy="employeeDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-employee-heading" v-text="$t('demoJhVue973App.employee.delete.question', { id: removeId })">
