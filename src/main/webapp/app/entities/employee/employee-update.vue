  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="demoJhVue973App.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="$t('demoJhVue973App.employee.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.firstName')" for="employee-firstName">First Name</label>
            <input
              type="text"
              class="form-control"
              name="firstName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.lastName')" for="employee-lastName">Last Name</label>
            <input
              type="text"
              class="form-control"
              name="lastName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.email')" for="employee-email">Email</label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.phoneNumber')" for="employee-phoneNumber"
              >Phone Number</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.hireDate')" for="employee-hireDate">Hire Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.salary')" for="employee-salary">Salary</label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.commissionPct')" for="employee-commissionPct"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.level')" for="employee-level">Level</label>
            <input
              type="number"
              class="form-control"
              name="level"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.contract')" for="employee-contract">Contract</label>
            <select
              class="form-control"
              name="contract"
            ...
            >
              <option
                ...
                v-bind:label="$t('demoJhVue973App.Contract.' + contract)"
              >
                {{ contract }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.cv')" for="employee-cv">Cv</label>
            <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.manager')" for="employee-manager">Manager</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.employee.department')" for="employee-department"
              >Department</label
            >
