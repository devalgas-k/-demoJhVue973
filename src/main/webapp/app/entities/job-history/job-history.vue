<template>
  <div>
    <h2 id="page-heading" data-cy="JobHistoryHeading">
      <span v-text="$t('demoJhVue973App.jobHistory.home.title')" id="job-history-heading">Job Histories</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('demoJhVue973App.jobHistory.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'JobHistoryCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('demoJhVue973App.jobHistory.home.createLabel')"> Create a new Job History </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && jobHistories && jobHistories.length === 0">
      <span v-text="$t('demoJhVue973App.jobHistory.home.notFound')">No jobHistories found</span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="jobHistories">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('startDate')">
              <span v-text="$t('demoJhVue973App.jobHistory.startDate')">Start Date</span>
            ...
            <th scope="row" v-on:click="changeOrder('endDate')">
              <span v-text="$t('demoJhVue973App.jobHistory.endDate')">End Date</span>
            ...
            <th scope="row" v-on:click="changeOrder('language')">
              <span v-text="$t('demoJhVue973App.jobHistory.language')">Language</span>
            ...
            <th scope="row" v-on:click="changeOrder('file')">
              <span v-text="$t('demoJhVue973App.jobHistory.file')">File</span>
            ...
            <th scope="row" v-on:click="changeOrder('date')">
              <span v-text="$t('demoJhVue973App.jobHistory.date')">Date</span>
            ...
            <th scope="row" v-on:click="changeOrder('duration')">
              <span v-text="$t('demoJhVue973App.jobHistory.duration')">Duration</span>
            ...
            <th scope="row" v-on:click="changeOrder('job.id')">
              <span v-text="$t('demoJhVue973App.jobHistory.job')">Job</span>
            ...
            <th scope="row" v-on:click="changeOrder('department.id')">
              <span v-text="$t('demoJhVue973App.jobHistory.department')">Department</span>
            ...
            <th scope="row" v-on:click="changeOrder('employee.id')">
              <span v-text="$t('demoJhVue973App.jobHistory.employee')">Employee</span>
        ...
        <tbody>
          <tr v-for="jobHistory in jobHistories" :key="jobHistory.id" data-cy="entityTable">
            ...
            <td v-text="$t('demoJhVue973App.Language.' + jobHistory.language)">{{ jobHistory.language }}</td>
            <td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="demoJhVue973App.jobHistory.delete.question" data-cy="jobHistoryDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-jobHistory-heading" v-text="$t('demoJhVue973App.jobHistory.delete.question', { id: removeId })">
