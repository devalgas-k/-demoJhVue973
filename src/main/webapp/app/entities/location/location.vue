        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('streetAddress')">
              <span v-text="$t('demoJhVue973App.location.streetAddress')">Street Address</span>
            ...
            <th scope="row" v-on:click="changeOrder('postalCode')">
              <span v-text="$t('demoJhVue973App.location.postalCode')">Postal Code</span>
            ...
            <th scope="row" v-on:click="changeOrder('city')">
              <span v-text="$t('demoJhVue973App.location.city')">City</span>
            ...
            <th scope="row" v-on:click="changeOrder('stateProvince')">
              <span v-text="$t('demoJhVue973App.location.stateProvince')">State Province</span>
            ...
            <th scope="row" v-on:click="changeOrder('country.id')">
              <span v-text="$t('demoJhVue973App.location.country')">Country</span>
