  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="demoJhVue973App.job.home.createOrEditLabel"
          data-cy="JobCreateUpdateHeading"
          v-text="$t('demoJhVue973App.job.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.jobTitle')" for="job-jobTitle">Job Title</label>
            <input
              type="text"
              class="form-control"
              name="jobTitle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.minSalary')" for="job-minSalary">Min Salary</label>
            <input
              type="number"
              class="form-control"
              name="minSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.maxSalary')" for="job-maxSalary">Max Salary</label>
            <input
              type="number"
              class="form-control"
              name="maxSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.subSalary')" for="job-subSalary">Sub Salary</label>
            <input
              type="number"
              class="form-control"
              name="subSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.totalSalary')" for="job-totalSalary">Total Salary</label>
            <input
              type="number"
              class="form-control"
              name="totalSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.date')" for="job-date">Date</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.codeCode')" for="job-codeCode">Code Code</label>
            <input
              type="text"
              class="form-control"
              name="codeCode"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.profil')" for="job-profil">Profil</label>
            <div>
              <img
          ...
          <div class="form-group">
            <label v-text="$t('demoJhVue973App.job.task')" for="job-task">Task</label>
            <select
              class="form-control"
              id="job-tasks"
              data-cy="task"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.job.employee')" for="job-employee">Employee</label>
