  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="demoJhVue973App.message.home.createOrEditLabel"
          data-cy="MessageCreateUpdateHeading"
          v-text="$t('demoJhVue973App.message.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.name')" for="message-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.email')" for="message-email">Email</label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.phone')" for="message-phone">Phone</label>
            <input
              type="text"
              class="form-control"
              name="phone"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.message')" for="message-message">Message</label>
            <textarea
              class="form-control"
              name="message"
              id="message-message"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.file')" for="message-file">File</label>
            <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.city')" for="message-city">City</label>
            <input
              type="text"
              class="form-control"
              name="city"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.otherCountry')" for="message-otherCountry"
              >Other Country</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.date')" for="message-date">Date</label>
            <div class="d-flex">
              <input
                id="message-date"
                data-cy="date"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('demoJhVue973App.message.subject')" for="message-subject">Subject</label>
