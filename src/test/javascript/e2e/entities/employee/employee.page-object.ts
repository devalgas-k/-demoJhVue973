...
export default class EmployeeComponentsPage extends AlertPage {
...
export class EmployeeDeleteDialog {
  ...
  title: ElementFinder = element(by.id('demoJhVue973App.employee.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-employee'));
}
