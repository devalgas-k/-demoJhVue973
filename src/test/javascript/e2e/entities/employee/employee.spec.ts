...
describe('Employee e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Employee page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/demoJhVue973App.employee.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/demoJhVue973App.employee.delete.question/);
