...
describe('Message e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Message page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/demoJhVue973App.message.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/demoJhVue973App.message.delete.question/);
