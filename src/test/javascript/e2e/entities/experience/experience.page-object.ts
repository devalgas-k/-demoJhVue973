...
export default class ExperienceComponentsPage extends AlertPage {
...
export class ExperienceDeleteDialog {
  ...
  title: ElementFinder = element(by.id('demoJhVue973App.experience.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-experience'));
}
