...
describe('Country e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Country page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/demoJhVue973App.country.home.createOrEditLabel/);
    });

    it('should create and save Countries', async () => {
      await updatePage.countryNameInput.sendKeys('countryName');
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/demoJhVue973App.country.delete.question/);
      ...
      it('should load edit Country page, fetch data and update', async () => {
        ...
        await updatePage.countryNameInput.clear();
        await updatePage.countryNameInput.sendKeys('modified');
