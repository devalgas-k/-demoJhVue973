...
export default class TaskComponentsPage extends AlertPage {
...
export class TaskDeleteDialog {
  ...
  title: ElementFinder = element(by.id('demoJhVue973App.task.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-task'));
}
