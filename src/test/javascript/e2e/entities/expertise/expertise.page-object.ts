...
export default class ExpertiseComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('expertise-heading'));
...
export class ExpertiseDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('demoJhVue973App.expertise.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-expertise'));
}
