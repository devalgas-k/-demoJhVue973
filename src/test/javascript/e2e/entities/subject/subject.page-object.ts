...
export default class SubjectComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('subject-heading'));
...
export class SubjectDeleteDialog {
  ...
  title: ElementFinder = element(by.id('demoJhVue973App.subject.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-subject'));
}
