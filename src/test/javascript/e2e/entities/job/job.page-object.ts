...
export default class JobComponentsPage extends AlertPage {
...
export class JobDeleteDialog {
  ...
  title: ElementFinder = element(by.id('demoJhVue973App.job.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-job'));
}
