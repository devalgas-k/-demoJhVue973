...
describe('Job e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Job page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/demoJhVue973App.job.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/demoJhVue973App.job.delete.question/);
