...
export default class DepartmentComponentsPage extends AlertPage {
...
export class DepartmentDeleteDialog {
  ...
  title: ElementFinder = element(by.id('demoJhVue973App.department.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-department'));
}
