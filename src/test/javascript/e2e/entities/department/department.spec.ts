...
describe('Department e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Department page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/demoJhVue973App.department.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/demoJhVue973App.department.delete.question/);
